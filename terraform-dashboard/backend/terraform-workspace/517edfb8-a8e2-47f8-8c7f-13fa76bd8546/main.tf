...
variable "cluster_version" {
  type = string
  description = "Variable cluster_version"
}

variable "vpc_id" {
  type = string
  description = "Variable vpc_id"
}

variable "subnet_ids" {
  type = string
  description = "Variable subnet_ids"
}

variable "node_groups" {
  type = string
  description = "Variable node_groups"
}

variable "cluster_endpoint_private_access" {
  type = string
  description = "Variable cluster_endpoint_private_access"
}

variable "cluster_endpoint_public_access" {
  type = string
  description = "Variable cluster_endpoint_public_access"
}
